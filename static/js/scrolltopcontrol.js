var scrolltotop={
	...
	controlHTML:'<div class="stSharp" style="  background-repeat: no-repeat;background-image:url(/e9/img/topback.png);width:54px;height:54px;cursor:pointer;" title="..."></div>'
		+'<div class="stApply" style="  background-repeat: no-repeat;background-image:url(/e9/img/apply.png);width:54px;height:99px;cursor:pointer;margin-top: -8px;"></div>',
